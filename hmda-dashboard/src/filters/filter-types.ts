...
// Map our filter types to the existing project types
import { HMDAProject } from '../types/Project';

// Define the enums we need for filtering
...
// Use existing types from HMDAProject
export type ProjectCategory = 'INFRASTRUCTURE' | 'URBAN_DEVELOPMENT' | 'ENVIRONMENTAL' | 'SMART_CITY';
export type ProjectStage = string;
export type Circle = 'CIRCLE_1' | 'CIRCLE_2' | 'CIRCLE_3' | 'CIRCLE_4' | 'CIRCLE_5';
