...
export const FILTER_CONFIGS: FilterConfig[] = [
  // Basic Filters
  {
    ...
    options: [
      { value: ProjectCategory.INFRASTRUCTURE, label: 'Infrastructure', color: '#F97316' },
      { value: ProjectCategory.URBAN_DEVELOPMENT, label: 'Urban Development', color: '#F59E0B' },
      { value: ProjectCategory.ENVIRONMENTAL, label: 'Environmental', color: '#10B981' },
      { value: ProjectCategory.SMART_CITY, label: 'Smart City', color: '#3B82F6' }
    ],
    icon: 'category',
  ...
  },
  {
    ...
    defaultOperator: FilterOperator.IN,
    options: [
      { value: ProjectStage.CONCEPTUALIZATION, label: '1. Conceptualization' },
      { value: ProjectStage.DPR_APPROVALS, label: '2. DPR & Approvals' },
      { value: ProjectStage.TENDERING, label: '3. Tendering' },
      { value: ProjectStage.CONTRACT_AWARD, label: '4. Contract Award' },
      { value: ProjectStage.CONSTRUCTION, label: '5. Construction' },
      { value: ProjectStage.QUALITY_CONTROL, label: '6. Quality Control' },
      { value: ProjectStage.TESTING_COMMISSIONING, label: '7. Testing & Commissioning' },
      { value: ProjectStage.HANDOVER, label: '8. Handover' },
      { value: ProjectStage.DLP_OM, label: '9. DLP & O&M' }
    ],
    icon: 'timeline',
  ...
  },
  {
    ...
    defaultOperator: FilterOperator.IN,
    options: [
      { value: Circle.CIRCLE_1, label: 'Circle 1 - Hyderabad Core' },
      { value: Circle.CIRCLE_2, label: 'Circle 2 - Rangareddy' },
      { value: Circle.CIRCLE_3, label: 'Circle 3 - Medchal-Malkajgiri' },
      { value: Circle.CIRCLE_4, label: 'Circle 4 - Sangareddy' },
      { value: Circle.CIRCLE_5, label: 'Circle 5 - Vikarabad' }
    ],
    icon: 'location_on',
  ...
  },
  {
    ...
    defaultOperator: FilterOperator.IN,
    options: [
      { value: RiskLevel.LOW, label: 'Low Risk', color: '#10B981' },
      { value: RiskLevel.MEDIUM, label: 'Medium Risk', color: '#F59E0B' },
      { value: RiskLevel.HIGH, label: 'High Risk', color: '#F97316' },
      { value: RiskLevel.CRITICAL, label: 'Critical Risk', color: '#EF4444' }
    ],
    icon: 'warning',
...
export const DEFAULT_FILTER_PRESETS = [
  {
    id: 'delayed_projects',
  ...
  },
  {
    ...
    filters: {
      stage: {
        ...
        label: 'Project Stage',
        operator: FilterOperator.IN,
        value: [ProjectStage.CONSTRUCTION, ProjectStage.QUALITY_CONTROL],
        active: true
      }
    }
  },
